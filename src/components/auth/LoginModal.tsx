...
import { Trophy, X, Mail, Lock, LogIn, ArrowRight } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

export const LoginModal: React.FC = () => {
  const { isLoginModalOpen, closeLoginModal, login, openRegisterModal } = useAuthStore();
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
        ...
        >
          ...
          <div className="flex items-center space-x-2.5 mb-6">
            ...
            <div>
              <h2 className="font-extrabold text-lg">Welcome Back</h2>
              <p className="text-xs text-bettom-muted">Log in to your Bettom account</p>
            </div>
          </div>
